...
object Prompts {
    fun system(objective: String): String {
        return """
    ...
    fun stepsCompletion(objective: String): String {
        return """
        $stepsSystem
    ...
    fun stepsUser(objective: String): String {
        return "OBJECTIVE: $objective"
    }

    fun uiState(last: String?, ui: String): String {
        return """
        LAST: ${last ?: "null"}
        UI:
        $ui
